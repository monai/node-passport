...
test('ResponseApdu', (t) => {
  ...
  t.test('constructor', (t) => {
    ...
    t.test('data is Buffer[0], sw1 is Buffer[2], sw2 is undefined', (t) => {
      ...
      t.hasStrict(apdu, { data: undefined }, 'data is undefined');
    ...
    t.test('data is Buffer[2], sw1 is Buffer[2], sw2 is undefined', (t) => {
      ...
      t.equal(apdu.data.length, 2, 'data is correct length');
  ...
  t.test('noError', (t) => {
    ...
    t.test('sw is 0x9100', (t) => {
      const apdu = new ResponseApdu(Buffer.from([0x91, 0x00]));
    ...
    t.test('sw is 0x9fff', (t) => {
      const apdu = new ResponseApdu(Buffer.from([0x9f, 0xff]));
