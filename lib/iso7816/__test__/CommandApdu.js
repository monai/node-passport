...
t.test('CommandApdu', (t) => {
  ...
  t.test('constructor', (t) => {
    ...
    t.test('le is < 0x10000', (t) => {
      ...
      t.equals(apdu.le, le, 'correct property le');
  ...
  t.test('toBuffer', (t) => {
    ...
    t.test('data length is 0xff and no Le', (t) => {
      ...
      t.equals(buffer.length, 4 + 1 + data.length, 'Lc field is short');
      t.equals(buffer[4], 0xff, 'Lc is equal to 0xff');
    ...
    t.test('data length is 0x100 and no Le', (t) => {
      ...
      t.equals(buffer.length, 4 + 3 + data.length, 'Lc field is extended');
      t.equals(buffer[4], 0x00, 'Lc byte 1 is equal to 0x00');
      t.equals(buffer[5], 0x01, 'Lc byte 2 is equal to 0x01');
      t.equals(buffer[6], 0x00, 'Lc byte 3 is equal to 0x00');
    ...
    t.test('no data and Le is 0xff', (t) => {
      ...
      t.equals(buffer.length, 4 + 1, 'Le field is short');
      t.equals(buffer[4], le, 'Le is equal to 0xff');
    ...
    t.test('no data and Le is 0x100', (t) => {
      ...
      t.equals(buffer.length, 4 + 1, 'Le field is short');
      t.equals(buffer[4], le, 'Le is equal to 0x00');
    ...
    t.test('no data and Le is 0x101', (t) => {
      ...
      t.equals(buffer.length, 4 + 3, 'Le field is extended 3 bytes long');
      t.equals(buffer[4], 0x00, 'Le byte 1 is equal to 0x00');
      t.equals(buffer[5], 0x01, 'Le byte 2 is equal to 0x01');
      t.equals(buffer[6], 0x01, 'Le byte 3 is equal to 0x01');
    ...
    t.test('data length is 0xff and Le is 0xff', (t) => {
      ...
      t.equals(buffer.length, 4 + 1 + data.length + 1, 'Le field is short');
      t.equals(leValue[0], 0xff, 'Le is equal to 0xff');
    ...
    t.test('data length is 0xff and Le is 0x100', (t) => {
      ...
      t.equals(buffer.length, 4 + 1 + data.length + 1, 'Le field is short');
      t.equals(leValue[0], 0x00, 'Le is equal to 0x00');
    ...
    t.test('data length is 0x100 and Le is 0x100', (t) => {
      ...
      t.equals(buffer.length, 4 + 3 + data.length + 1, 'Le field is short');
      t.equals(leValue[0], 0x00, 'Le is equal to 0x00');
    ...
    t.test('data length is 0xff and Le is 0x101', (t) => {
      ...
      t.equals(buffer.length, 4 + 1 + data.length + 3, 'Le is extended 3 byte long');
      t.equals(leValue[0], 0x00, 'Le byte 1 is equal to 0x00');
      t.equals(leValue[1], 0x01, 'Le byte 2 is equal to 0x01');
      t.equals(leValue[2], 0x01, 'Le byte 3 is equal to 0x01');
    ...
    t.test('data length is 0x100 and Le is 0x101', (t) => {
      ...
      t.equals(buffer.length, 4 + 3 + data.length + 2, 'Le is extended 2 byte long');
      t.equals(leValue[0], 0x01, 'Le byte 2 is equal to 0x01');
      t.equals(leValue[1], 0x01, 'Le byte 3 is equal to 0x01');
    ...
    t.test('data length is 0xff and Le is 0x10000', (t) => {
      ...
      t.equals(buffer.length, 4 + 1 + data.length + 3, 'Le is extended 3 byte long');
      t.equals(leValue[0], 0x00, 'Le byte 1 is equal to 0x00');
      t.equals(leValue[1], 0x00, 'Le byte 2 is equal to 0x00');
      t.equals(leValue[2], 0x00, 'Le byte 3 is equal to 0x00');
    ...
    t.test('data length is 0x100 and Le is 0x10000', (t) => {
      ...
      t.equals(buffer.length, 4 + 3 + data.length + 2, 'Le is extended 2 byte long');
      t.equals(leValue[0], 0x00, 'Le byte 2 is equal to 0x00');
      t.equals(leValue[1], 0x00, 'Le byte 3 is equal to 0x00');
