...
import * as lifeCycleStatus from '../dos/fcp/life_cycle_status.mjs';
import * as fileDescriptor from '../dos/fcp/file_descriptor.mjs';
import * as securityAttributeExpanded from '../dos/fcp/security_attribute_expanded.mjs';
