...
import * as usageQualifierByte from './usage_qualifier_byte/digital_signature.mjs';
...
const template = {
  ...
  0x91: (node) => ({
    description: node.length > 0 ? 'random number' : 'random number provided by the card',
  }),
  0x92: (node) => ({
    description: node.length > 0 ? 'time stamp' : 'time stamp provided by the card',
  }),
  0x93: (node) => ({
    description: node.length > 0 ? 'digital signature counter' : 'previous digital signature counter plus one',
  }),
  0x94: {
